...
def process_playlist(playlist_url):
    ...
    for track_number, video_url in enumerate(video_urls, start=1):
        audio_file, thumbnail_file, _, _, _, _, _, _ = download_audio_and_metadata(
            video_url, track_number, playlist_title
        )
